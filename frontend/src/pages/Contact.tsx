...
import { mockContactObjects, ContactObject } from '../data/mockData';
...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitStatus({
        type: 'success',
        message: 'Votre message a été reçu! Nous vous répondrons dans les plus brefs délais. (Note: En mode statique, les messages ne sont pas réellement envoyés)',
      });
