...
import { mockProfessionalServices, ProfessionalService } from '../data/mockData';

interface Service extends ProfessionalService {}
  ...
  useEffect(() => {
    const loadServices = () => {
      try {
        ...
        setTimeout(() => {
          setServices(mockProfessionalServices);
          setLoading(false);
        }, 500);
      } catch (error) {
